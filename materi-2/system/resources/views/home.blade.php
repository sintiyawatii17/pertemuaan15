            ...
            <div class="col-md-3">
              ...
              <select name="" class="form-control" id="kabupaten" onchange="gantiKabupaten(this.value)">
               <option class="">Pilih Kabupaten</option>
                <option class="">Kab. Pontianak</option>
                <option class="">Kab. Ketapang</option>
              ...
              <option value="">Kec.Pontianak Selatan</option> 
              <option value="">Kec.Benua kayong</option> 
              </select>
            </div>
            <div class="col-md-3">
             ...
             <option value="">Des.Kapur</option> 
              <option class="">Des.Kauman</option>  
              </select>
            </div>
